...
function createData(id, img, name, sex, age, company, position, detail) {
  return {
    id,
    img,
    name,
...
export default function EnhancedTable() {
  ...
  React.useEffect(async () => {
    let getAllUser = await userService
      .getAllUser()
      .then((data) => {
    ...
    var dataUser = getAllUser.data.group.map((datas) =>
      datas.members.map(
        (memb) =>
  ...
  return (
    <Container maxWidth={false}>
      <Grid container spacing={3}>
        <Grid xs={12}>
          <Page className={classes.root} title="Review">
                          ...
                          >
                            ...
                            {row.face?.member_picture ? (
                              ...
                              <TableCell
                                ...
                                onClick={() => {
                                  navigate("/app/staff/detailstaff/" + row.id, {
                                    push: true,
                                  });
                                }}
                              >
